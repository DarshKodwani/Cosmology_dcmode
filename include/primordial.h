...
struct primordial {
  ...
  // Darsh start : Adding parameter for binned power spectrum //
  double k_amp;
  double dk_amp;
  double dAmp_k;
  //Darsh end //
  ...
  /* (Xin) decaying tensor mode */
  double f_addct, n_addct, alpha_addct;    /* decaying tensor autospectrum */
  double c_t_addct, n_t_addct, alpha_t_addct;  /* cross-correlation between tensor and decaying-decay mode */
  /* -- */
  ...
  /* (Xin) adiabatic-decaying-scalar primordial spectrum */
  double f_addcs;
  double n_addcs;
  double alpha_addcs;
  ...
  /* (Xin) cross-correlation of adiabatic-decaying-scalar with others */
  double c_ad_addcs, c_addcs_bi, c_addcs_cdi, c_addcs_nid, c_addcs_niv;
  double n_ad_addcs, n_addcs_bi, n_addcs_cdi, n_addcs_nid, n_addcs_niv;
  double alpha_ad_addcs, alpha_addcs_bi, alpha_addcs_cdi, alpha_addcs_nid, alpha_addcs_niv;
  /* -- */
